...
\usepackage[english, masters]{title_page_wit}

% Set up the thesis
\author{Name Surname}
\title{Topic of the Master's Thesis}
\supervisor{Supervisor Name Surname}
\fieldofstudy{Artificial Intelligence}
\specialty{}
\keywords{keyword1, keyword2}
\summary{Short summary of the master's thesis.}
\year=2022
...
% 				\put(11,520){\makebox(0,0)[l]{\large \textsc{Faculty of Information and Communication Technology}}}
...
% 				\put(106,-80){\makebox(0,0)[bl]{\large \textsc{Wrocław 2022}}}
% 			\end{picture}
% 		\end{center}	
% 		\vspace*{\fill}
% 	\end{titlingpage}
